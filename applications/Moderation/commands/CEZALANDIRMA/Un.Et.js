...
module.exports = {
    name: "etc-kaldır",
    command: ["etc-kaldir", "etkaldir","etkaldır","etkinlikcezalı-kaldır","etkinlikcezalıkaldır","etkinlikcezalikaldir","unetc"],
    aliases: "unetc <#No/@cartel/ID>",
  ...
  komutClient: async function (client, message, args) {
    ...
    if(await ETKINLIK.findById(cartelcim.id)) {
