...
module.exports = async (ban) => {
    ...
    embed.açıklama(`${ban.user} (\`${ban.user.id}\`) kişisi, ${entry.executor} (\`${entry.executor.id}\`) tarafından sunucudan \`Sağ-Tık\` ile yasaklandı! yasaklayan kişi ise yasaklandı.`);
