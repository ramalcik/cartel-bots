...
module.exports = async (oldGuild, newGuild) => {
    ...
    let embed = new richEmbed().başlık("Sunucu Ayarları Güncellendi!")
    ...
    embed.açıklama(` ${entry.executor} (\`${entry.executor.id}\`) tarafından sunucudan sunucu güncellendi! Güncelleyen kişi banlandı ve sunucu eski haline getirildi.`);
    let loged = newGuild.kanalıBul("cartelfx");
